---
name: github-token-permissions-overview - Reference
description: Complete reference for GITHUB_TOKEN Permissions Overview
---

# GITHUB_TOKEN Permissions Overview - Reference
