...
| ---------- | ------- | --------------: | ----- |
| [`build`](plugins/build/skills/build) | 1.1.1 | 14 | Use when building a Go CLI, wiring release-please for automated versioning, packaging a container… |
| [`enforce`](plugins/enforce/skills/enforce) | 1.1.1 | 35 | Use when setting up or reviewing policy-as-code enforcement — writing Kyverno or OPA policies… |
| [`patterns`](plugins/patterns/skills/patterns) | 1.1.1 | 39 | Use when designing or reviewing automation architecture for GitHub Actions, Argo Workflows, or Argo… |
...
- **Consolidating Automated Dependency Updates** — This guide outlines strategies for merging…
...
- **CI/CD Compliance Audits for Component Integrity** — Implement automated checks within CI/CD pipelines…
...
- **Authoritative Architectural Documentation and Data Contracts** — Guide to establishing and maintaining architectural…
